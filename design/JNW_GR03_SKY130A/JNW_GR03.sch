...
N -160 -420 -160 -400 {lab=#net2}
N -330 -420 -160 -420 {lab=#net2}
N -330 -420 -330 -130 {lab=#net2}
N -60 -20 -20 -20 {lab=VSS}
N 140 -510 140 -440 {lab=I_TEMP}
...
C {JNW_ATR_SKY130A/JNWATR_PCH_4C5F0.sym} 100 -540 0 0 {name=x1[1:0]}
...
C {devices/opin.sym} 140 -440 1 0 {name=I_TEMP lab=I_TEMP}
