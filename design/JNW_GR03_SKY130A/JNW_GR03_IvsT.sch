...
N -10 -540 -10 -520 {lab=I_TEMP}
N -150 -540 -10 -540 {lab=I_TEMP}
...
C {JNW_ATR_SKY130A/JNWATR_PCH_2C5F0.sym} -210 -650 0 1 {name=x[6:0]}
...
C {cborder/border_s.sym} 120 -40 0 0 {}
C {JNW_TR_SKY130A/JNWTR_CAPX1.sym} -10 -460 0 0 {name=x2 }
