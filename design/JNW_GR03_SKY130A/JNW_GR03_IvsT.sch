...
N -160 -540 -160 -400 {lab=#net1}
N -160 -610 -140 -600 {lab=VDD}
C {devices/ipin.sym} -640 -600 0 0 {name=VDD lab=VDD}
C {devices/ipin.sym} -640 -20 0 0 {name=VSS lab=VSS}
C {JNW_TR_SKY130A/JNWTR_RPPO2.sym} -260 -240 1 0 {name=x4 }
C {JNW_ATR_SKY130A/JNWATR_PCH_2C5F0.sym} -100 -540 0 0 {name=x5}
C {JNW_ATR_SKY130A/JNWATR_PCH_2C5F0.sym} -220 -540 0 1 {name=x2}
...
C {cborder/border_s.sym} -1280 110 0 0 {}
C {JNW_TR_SKY130A/JNWTR_CAPX1.sym} -160 -550 0 0 {name=x1 }
