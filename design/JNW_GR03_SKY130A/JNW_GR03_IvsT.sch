...
N -150 -540 -10 -540 {lab=#net1}
N 100 -620 100 -580 {lab=I_TEMP}
N 20 -650 60 -650 {lab=#net1}
N 20 -690 20 -650 {lab=#net1}
N -150 -690 20 -690 {lab=#net1}
N -150 -690 -150 -650 {lab=#net1}
N 100 -710 100 -680 {lab=VDD}
N -10 -710 100 -710 {lab=VDD}
N 100 -650 120 -650 {lab=VDD}
N 120 -710 120 -650 {lab=VDD}
N 100 -710 120 -710 {lab=VDD}
C {devices/ipin.sym} -630 -710 0 0 {name=VDD lab=VDD}
C {devices/ipin.sym} -630 -130 0 0 {name=VSS lab=VSS}
C {JNW_TR_SKY130A/JNWTR_RPPO8.sym} -250 -350 1 0 {name=x4 }
C {JNW_ATR_SKY130A/JNWATR_PCH_2C5F0.sym} -90 -650 0 0 {name=x5[2:0]}
