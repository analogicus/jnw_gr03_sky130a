...
N 400 140 400 200 {lab=LPI}
N 260 140 400 140 {lab=LPI}
C {devices/ipin.sym} -40 10 0 0 {name=VDD lab=VDD}
C {devices/ipin.sym} -10 590 0 0 {name=VSS lab=VSS}
C {JNW_TR_SKY130A/JNWTR_RPPO8.sym} 160 370 1 0 {name=x1 }
C {JNW_ATR_SKY130A/JNWATR_PCH_2C5F0.sym} 320 70 0 0 {name=x5[2:0]}
...
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 200 510 0 1 {name=x11[5:0]}
